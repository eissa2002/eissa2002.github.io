  ...
  return (
    <div className="card section-card">
      <div className="card-head">
        ...
        <span className="spacer" />
        <span className="status-pill"><span className="dot" style={{ background: '#2EE6A6' }} />Reply &lt; 24h</span>
      </div>
      <div className="card-body">
...
Object.assign(window, { Sidebar, Topbar, Hero, Featured, Projects, Experience, Stack, Publication, Contact, StatusBadge, Viz, Typer, Ticker });